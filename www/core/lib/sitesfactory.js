...
.provider('$mmSitesFactory', function() {
    ...
    this.$get = function($http, $q, $mmWS, $mmDB, $mmConfig, $log, md5, $mmApp, $translate, $mmUtil, $mmFS,
        ...
        Site.prototype.request = function(method, data, preSets) {
            ...
            if (site.getInfo() && !site.wsAvailable(method, false)) {
                if (site.wsAvailable(mmCoreWSPrefix + method, false)) {
                    ...
                    return $translate('mm.core.wsfunctionnotavailable').then(function(errorMessage) {
            ...
            return getFromCache(site, method, data, preSets).then(function(data) {
                ...
                return $mmWS.call(method, data, wsPreSets).then(function(response) {
                    ...
                    if (error === mmCoreSessionExpired) {
                        ...
                        return $translate('mm.core.lostconnection').then(function(errorMessage) {
                            return $q.reject(errorMessage);
                        });
